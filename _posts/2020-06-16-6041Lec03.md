...
가 성립한다고 할 때 Q,W,E는 independence인가? 답은 알 수 없다.
...
<p align="center">
  <img width="500" src="https://user-images.githubusercontent.com/46151024/85027592-0e940500-b1b5-11ea-8c5e-4b26ce2c9800.JPG"
   <br>
  그림 5. pairwise independence
</p>

위의 문제에서 P(A)=1/2, P(B)=1/2, A is independent of B 를 이끌어낼 수 잇다.

그리고 $P(C)=1/2, P(C \cap A) = 1/4, P(A \cap B \cap C) = 1/4, P(C \| A \cap B) = 1$ 임을 알 수 있다.
...
Ref John N Tsitsiklis, Introduction to probability, 2nd ED, 2008
