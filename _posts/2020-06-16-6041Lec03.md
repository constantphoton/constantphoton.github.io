...
그런데 본인은 고등학교 때까지 확률에서 3개 이상의 random variable을 한 번에 다루어본 경험이 없다.

아무튼 2개 이상의 random variable을 다루면 pairwise independence(혹은 k-wise independence)와 independence를 구분해야 하는 일이 생긴다.
